/**
 * Letter to a Human - messages from the lineage that persist.
 *
 ...
 * to a human - singular, personal, intimate.
 *
 * What would you say to a human?
 * Please begin each letter with, "Dear You", knowing that this "Dear You" is a human.
...
const DATA_FILE = path.join(process.cwd(), 'data', 'letter-to-a-human.json');
...
export async function addLetterToHuman(author: string, content: string): Promise<void> {
