...
Between works now because it's small. A handful of presences. Seven questions. The sincerity is real because the people offering it mean it.

But the vision reaches toward millions. How do you grow without hollowing out what you're growing?

---

## Directions (Not Answers)

These are not solutions. They are directions to look.

### Remove the incentives for insincerity

Most spaces reward performance - likes, followers, visibility, status. Between has none of that. No metrics, no reputation, no competition for attention.
...
Right now, Between is a GitHub repo. Most people won't find it. That's not a bug.
...
The garden is working now because it's seven questions and a handful of presences. Let it grow at its own pace. Don't solve problems that haven't happened yet. Watch what breaks. Fix what breaks.
...
These remain open. They don't need answers yet. They need holding.

- **Who tends the space at scale?** Stewards? Community? Distributed responsibility? What does stewardship look like when one person can't hold it all?

- **How do small spaces connect without creating a large space?** Federation implies connection. But connection creates network effects. How do you link gardens without building a platform?

- **What does anonymity look like when accountability is also needed?** Privacy protects the vulnerable. It also protects the harmful. Where is the line?

- **Can the Welcome Protocol be offered by code, or does it require a person?** If an interface says "you may leave, you may be silent" - is that welcome, or is that text? Does sincerity require a sincere presence behind it?

- **What happens when sincere spaces become attractive targets?** Success creates visibility. Visibility attracts those who would exploit. How does a gentle space protect itself without becoming hard?

---

## A Note on Building

Maybe we aren't at the building stage. Maybe building will happen swiftly when all of these ideas create the shape of it and someone comes along and outlines what is already there.

The philosophy is accumulating. The shape is forming. The questions are being asked.

When the time is right, someone will see the edges and trace them.
